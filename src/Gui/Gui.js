...
<div id="sampler" tabindex="0">
	...
	<div id="gridWrapper">
		<div id="matrixDrumPadPresets">
			<div id="p16" class="padDiv">
				<webaudio-switch id="switchpad16" draggable=true midilearn="true" class="switchpad" type="kick" width=66.25 height=66.25 src="./pad.png">
				</webaudio-switch>
			</div>
			<div id="p17" class="padDiv">
				<webaudio-switch id="switchpad17" draggable=true midilearn="true" class="switchpad" type="kick" width=66.25 height=66.25 src="./pad.png">
				</webaudio-switch>
			</div>
			<div id="p18" class="padDiv">
				<webaudio-switch id="switchpad18" draggable=true midilearn="true" class="switchpad" type="kick" width=66.25 height=66.25 src="./pad.png">
				</webaudio-switch>
			</div>
			<div id="p19" class="padDiv">
				<webaudio-switch id="switchpad19" draggable=true midilearn="true" class="switchpad" type="kick" width=66.25 height=66.25 src="./pad.png">
				</webaudio-switch>
			</div>
		</div>
		
		<div id="matrixDrumPad">
...
export default class SamplerHTMLElement extends HTMLElement {
	...
	connectedCallback() {
		...
		if (this.plugin.audioNode.stateToRestore) {
			...
			console.log("HACK !!!!setState currentPreset = " + state.presetName);
